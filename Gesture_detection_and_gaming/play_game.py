...
PATH_TO_CKPT = 'M:/Gesture_detection_and_gaming/inference_graph/frozen_inference_graph.pb'

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join('M:/Gesture_detection_and_gaming/object-detection.pbtxt')
